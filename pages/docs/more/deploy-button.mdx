...
export const meta = {
  ...
  lastEdited: '2020-08-28T08:48:31.000Z',
...
**Value**: Title of an example deployment.<br />
**Type**: String
...
on a Deploy Button and entering the Deploy Flow.
...
**Value**: Description of an example deployment.<br />
**Type**: String
...
**Value**: URL of an example deployment.<br />
**Type**: String
...
**Value**: URL of the screenshot of an example deployment.<br />
**Type**: String
