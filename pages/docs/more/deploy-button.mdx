...
export const meta = {
  ...
  editUrl: 'pages/docs/more/deploy-button.mdx',
  lastEdited: '2020-08-28T10:38:31.000Z',
  image: `https://vercel.com${process.env.ASSETS}/docs/more/deploy-button/deploy-button.png`,
}
...
<Image
  src={`${process.env.ASSETS}/docs/more/deploy-button/import-flow.png`}
  width={1280 / 2}
  height={1594 / 2}
  shadow
/>
<Caption>
  The <OrgName /> Import Flow deploying a{' '}
  <Link href="https://github.com/vercel/next.js/tree/canary/examples/cms-datocms#deploy-your-own">
    Next.js and DatoCMS project
  </Link>
  .
</Caption>
...
The base of the Deploy Button URL is the <OrgName /> Git Import Flow, found at <https://vercel.com/new/git/external>.
...
<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?
      <b style={{ color: 'var(--geist-background)' }}>
        repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world
      </b>
    </span>
  }
/>
<Caption>
  ...
  <InlineCode>repository-url</InlineCode> Repository URL parameter.
</Caption>
...
<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&env=PUBLIC_API_KEY,API_SECRET_KEY"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      ...
      <b style={{ color: 'var(--geist-background)' }}>env=PUBLIC_API_KEY,API_SECRET_KEY</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the <InlineCode>env</InlineCode>{' '}
  parameter.
</Caption>
...
<Note>
  The description provided through this parameter will only show if Required
  Environment Variables are set.
</Note>
<Spacer />

<Image
  src={`${process.env.ASSETS}/docs/more/deploy-button/environment-variable-description.png`}
  width={1232 / 2}
  height={422 / 2}
  shadow
/>
<Caption>
  An example Required Environment Variables section using the Environment
  Variable Description parameter to add context.
</Caption>

<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&env=PUBLIC_API_KEY&envDescription=Enter%20your%20public%20API%20Key."
  text={
    <span style={{ color: 'var(--accents-3)' }}>
...
<Image
  src={`${process.env.ASSETS}/docs/more/deploy-button/environment-variable-link.png`}
  width={1232 / 2}
  height={442 / 2}
  shadow
/>
<Caption>
  An example Required Environment Variables section using the Environment
  Variable Link parameter to add context.
</Caption>

<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&env=PUBLIC_API_KEY&envDescription=Enter%20your%20public%20API%20Key.&envLink=https%3A%2F%2Fvercel.com%2Fdocs"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      ...
      <b style={{ color: 'var(--geist-background)' }}>envLink=https%3A%2F%2Fvercel.com%2Fdocs</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the <InlineCode>envLink</InlineCode>{' '}
  parameter.
</Caption>
...
<Image
  src={`${process.env.ASSETS}/docs/more/deploy-button/redirect.jpg`}
  width={1600 / 2}
  height={500 / 2}
  shadow
/>
...
<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&redirect-url=my-headless-application.com"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&amp;
      <b style={{ color: 'var(--geist-background)' }}>redirect-url=my-headless-application.com</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the{' '}
  <InlineCode>redirect-url</InlineCode> parameter.
</Caption>
...
​<OrgName /> additionally attaches some "Callback Parameters" to the defined Redirect URL when the user is redirected. The following parameters give you access to information about the project the user has created and deployed, for you to integrate with <OrgName /> after the user is sent back to you.
...
<Image
  src={`${process.env.ASSETS}/docs/more/deploy-button/redirect-logo.jpg`}
  width={1600 / 2}
  height={500 / 2}
  shadow
/>
<Caption>
  An example of the redirect UI with a Developer logo and name when the Redirect
  URL and Developer ID parameters are used.
</Caption>

<Note>
  This parameter requires the <Link href="#redirect-url">Redirect URL</Link>{' '}
  parameter to be set and also that the Integration website field matches the
  Redirect URL value.
</Note>
<Spacer />
...
<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&redirect-url=https%3A%2F%2Fmy-headless-application.com&developer-id=oac_7rUTiCMow23Gyfao9RQQ3Es2"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&amp;redirect-url=https%3A%2F%2Fmy-headless-application.com&amp;
      <b style={{ color: 'var(--geist-background)' }}>developer-id=oac_7rUTiCMow23Gyfao9RQQ3Es2</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the{' '}
  <InlineCode>redirect-url</InlineCode> and the{' '}
  <InlineCode>developer-id</InlineCode> parameters.
</Caption>
...
<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&redirect-url=https%3A%2F%2Fmy-headless-application.com&production-deploy-hook=MyHeadlessProject"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&amp;redirect-url=https%3A%2F%2Fmy-headless-application.com&amp;
      <b style={{ color: 'var(--geist-background)' }}>production-deploy-hook=MyHeadlessProject</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the{' '}
  <InlineCode>redirect-url</InlineCode> and the{' '}
  <InlineCode>production-deploy-hook</InlineCode> parameters.
</Caption>
...
<Note>
  If there is an existing project using the name passed with this parameter, the
  user will be required to define a new project name, and therefore the project
  is not guaranteed to have the specified name.
</Note>
<Spacer />
...
<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&project-name=my-awesome-project"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&amp;
      <b style={{ color: 'var(--geist-background)' }}>project-name=my-awesome-project</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the{' '}
  <InlineCode>project-name</InlineCode> parameter.
</Caption>
...
<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&repository-name=my-awesome-project"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&amp;
      <b style={{ color: 'var(--geist-background)' }}>repository-name=my-awesome-project</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the{' '}
  <InlineCode>repository-name</InlineCode> parameter.
</Caption>

### Demo Title

**Parameter**: `demo-title`<br />
**Value**: The title of an example deployment.<br />
**Type**: String
...
showcase an example successful deployment to the user clicking
the Deploy Button and entering the Deploy Flow.

<Note>
  The Demo card is displayed only when all <InlineCode>demo-*</InlineCode>{' '}
  parameters are provided.
</Note>

<Image
  src={`${process.env.ASSETS}/docs/more/deploy-button/new-git-external.png`}
  width={1792 / 2}
  height={984 / 2}
  shadow
/>
<Caption>
  An example of the Demo Card customized with the Demo Title <i>APM Story</i>.
</Caption>
...
<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&demo-title=APM%20Story"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&amp;
      <b style={{ color: 'var(--geist-background)' }}>demo-title=APM%20Story</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the{' '}
  <InlineCode>demo-title</InlineCode> parameter.
</Caption>

### Demo Description

**Parameter**: `demo-description`<br />
**Value**: The description of the example deployment.<br />
**Type**: String
...
/>
<Caption>
  An example of the Demo Card customized with the Demo Description parameter.
</Caption>

<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&demo-description=A%20statically%20generated%20blog%20example%20using%20Next.js%20%and%20DatoCMS"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&amp;
      <b style={{ color: 'var(--geist-background)' }}>demo-description=A%20statically%20generated%20blog%20example%20using%20Next.js%20%and%20DatoCMS</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the{' '}
  <InlineCode>demo-description</InlineCode> parameter.
</Caption>

### Demo URL

**Parameter**: `demo-url`<br />
**Value**: The URL of the example deployment.<br />
**Type**: String

This parameter allows you to specify the URL of an
example successful deployment.
...
/>
<Caption>
  In this example, clicking on <i>APM Story</i> takes the user to the Demo URL.
</Caption>

<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&demo-url=https%3A%2F%2Fnextjs.org"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&amp;
      <b style={{ color: 'var(--geist-background)' }}>demo-url=https%3A%2F%2Fnextjs.org</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the{' '}
  <InlineCode>demo-url</InlineCode> parameter.
</Caption>

### Demo Image

**Parameter**: `demo-image`<br />
**Value**: The URL of the screenshot of an example deployment.<br />
**Type**: String

This parameter allows you to specify the URL of the
screenshot of an example successful deployment.

The parameter is part of the Demo Card parameters. The Demo Card should
showcase an example successful deployment to the user clicking
the Deploy Button and entering the Deploy Flow.

The image specified by Demo Image will be displayed on the Demo Card.
...
/>
<Caption>
  An example of the Demo card customized with the screenshot of a successful{' '}
  <i>APM Story</i> deployment.
</Caption>

<Snippet
  dark
  prompt={false}
  copyText="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&demo-image=https%3A%2F%2Fexample.com%2Fimage.png"
  text={
    <span style={{ color: 'var(--accents-3)' }}>
      https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world&amp;
      <b style={{ color: 'var(--geist-background)' }}>demo-image=https%3A%2F%2Fexample.com%2Fimage.png</b>
    </span>
  }
/>
<Caption>
  An example Deploy Button source URL using the{' '}
  <InlineCode>demo-image</InlineCode> parameter.
</Caption>
